...
var datePickerController = (function datePickerController() {
    ...
    function affectJSON(json) {
        ...
        var key,
            switchObj = {
                ...
                lang: function (value) {
                    if (
                        typeof value === "string" &&
                        value.search(/^[a-z]{2,3}(-([a-z]{2}))?$/i) != -1
                    ) {
                ...
                bespoketitles: function (value) {
                    if (typeof value === "object") {
                        ...
                        for (var dt in value) {
                            if (
                                value.hasOwnProperty(dt) &&
                                String(dt).match(wcDateRegExp) != -1
                            ) {
        ...
        for (key in json) {
            ...
            (
                (switchObj.hasOwnProperty(String(key).toLowerCase()) &&
                    switchObj[String(key).toLowerCase()]) ||
                switchObj._default
            )(json[key]);
        }
    }
    ...
    function parseJSON(str) {
        ...
        try {
            ...
            if (typeof JSON === "object" && JSON.parse) {
                ...
                /debug|lang|nodrag|buttontabindex|derivelocale|mousewheel|cellformat|titleformat|statusformat|describedby|finalopacity|bespoketitles|dateparsefallback/.test(
                    str.toLowerCase()
                )
            ) {
                var f = Function(
    ...
    function pad(value, length) {
        ...
        return (
            "0000".substr(0, length - Math.min(String(value).length, length)) +
            value
        );
    }
    ...
    function datePicker(options) {
        ...
        this.getDateExceptions = function (y, m) {
            ...
            while (+workingDt <= dtUpper) {
                ...
                for (rNumber = 0; rNumber < rLength; rNumber++) {
                    dt1 = String(o.dateList[rNumber].rLow)
                        .replace(/^(\*\*\*\*)/, workingY)
                        .replace(/^(\d\d\d\d)(\*\*)/, "$1" + workingM);
                    dt2 = String(o.dateList[rNumber].rHigh)
                        .replace(/^(\*\*\*\*)/, workingY)
                        .replace(/^(\d\d\d\d)(\*\*)/, "$1" + workingM);
                ...
                workingDt =
                    workingDt.getFullYear() +
                    "" +
                    pad(workingDt.getMonth() + 1);
            }
        ...
        this.reposition = function () {
            ...
            var osh = o.div.offsetHeight,
                ...
                bSpace =
                    ...
                    parseInt(pos[1] + elem.offsetHeight + 2);

            o.div.style.visibility = "visible";

            o.div.style.left =
                Number(
                    parseInt(trueBody.clientWidth + scrollLeft) <
                        parseInt(osw + pos[0])
                        ? Math.abs(
                              parseInt(trueBody.clientWidth + scrollLeft - osw)
                          )
                        : pos[0]
                ) + "px";
            o.div.style.top =
        ...
        this.addAccessibleDate = function () {
            ...
            if (td && !td.getElementsByTagName("span").length) {
                ...
                if (noS) {
                    ...
                    spnC.appendChild(
                        document.createTextNode(getTitleTranslation(13))
                    );
                    td.appendChild(spnC);
                }
        ...
        this.updateTable = function (noCallback) {
            ...
            if (o.timerSet && !o.delayedUpdate) {
                ...
                if (o.monthInc) {
                    ...
                    d.setDate(
                        Math.min(n, daysInMonth(d.getMonth(), d.getFullYear()))
                    );
            ...
            var dt,
                ...
                stub =
                    String(tmpDate.getFullYear()) + pad(tmpDate.getMonth() + 1),
                //
            ...
            for (var curr = 0; curr < 42; curr++) {
                ...
                if (
                    ...
                    if (
                        ...
                        if (
                            (currentDate in dts && dts[currentDate] == 1) ||
                            // or
            ...
            if (document.getElementById("fd-but-" + this.id)) {
                document
                    ...
                    .parentNode.removeChild(
                        document.getElementById("fd-but-" + this.id)
                    );
            }
        ...
        this.create = function () {
            ...
            function createThAndButton(tr, obj) {
                for (var i = 0, details; (details = obj[i]); i++) {
                    ...
                    but.appendChild(
                        document.createTextNode(details.text || o.nbsp)
                    );
            ...
            if (this.finalOpacity < 100) {
                this.idiv.style.opacity = Math.min(
                    Math.max(parseInt(this.finalOpacity, 10) / 100, 0.2),
                    1
                );
            }
            ...
            this.butPrevYear = document.getElementById(
                this.id + "-prev-year-but"
            );
            this.butPrevMonth = document.getElementById(
                this.id + "-prev-month-but"
            );
            this.butToday = document.getElementById(this.id + "-today-but");
            this.butNextYear = document.getElementById(
                this.id + "-next-year-but"
            );
            this.butNextMonth = document.getElementById(
                this.id + "-next-month-but"
            );
        ...
        this.trackDrag = function (e) {
            e = e || window.event;
            var diffx =
                (e.pageX ? e.pageX : e.clientX ? e.clientX : e.x) - o.mx;
            var diffy =
                (e.pageY ? e.pageY : e.clientY ? e.clientY : e.Y) - o.my;
            o.div.style.left =
                Math.round(o.x + diffx) > 0
                    ? Math.round(o.x + diffx) + "px"
                    : "0px";
            o.div.style.top =
                Math.round(o.y + diffy) > 0
                    ? Math.round(o.y + diffy) + "px"
                    : "0px";
            if (oldIE === 6 && !o.staticPos) {
                o.iePopUp.style.top = o.div.style.top;
                o.iePopUp.style.left = o.div.style.left;
        ...
        this.onmousedown = function (e) {
            ...
            if (
                (o.div.className + origEl.className).search("fd-disabled") != -1
            ) {
                return true;
            }
            ...
            while (el.parentNode) {
                ...
                if (el.tagName && el.tagName.toLowerCase() == "td") {
                    if (
                        ...
                        el.className.search(noSelectionRegExp) != -1
                    ) {
                        return stopEvent(e);
                    }
                    ...
                    el.className.search(/date-picker-day-header/) != -1
                ) {
        ...
        this.onkeydown = function (e) {
            ...
            if (kc == 13) {
                ...
                if (
                    ...
                    td.className.search(/out-of-range|day-disabled/) != -1
                ) {
                    return stopEvent(e);
                }
                o.dateSet = new Date(o.date);
            ...
            switch (el.tagName.toLowerCase()) {
                ...
                case "th":
                    ...
                    if (el.className.search(/drag-enabled/) != -1) {
                        ...
                        el.className.search(/date-picker-week-header/) != -1
                    ) {
    ...
    datePicker.prototype.addDatesToList = function (dateObj, areDisabled) {
        ...
        for (startD in dateObj) {
            if (
                ...
                (dateObj[startD] == 1 ||
                    String(dateObj[startD]).search(wcDateRegExp) != -1)
            ) {
                if (
                    dateObj[startD] != 1 &&
                    Number(
                        String(startD)
                            .replace(/^\*\*\*\*/, 2010)
                            .replace(/^(\d\d\d\d)(\*\*)/, "$1" + "22")
                    ) >
                        Number(
                            String(dateObj[startD])
                                .replace(/^\*\*\*\*/, 2010)
                                .replace(/^(\d\d\d\d)(\*\*)/, "$1" + "22")
                        )
                ) {
    ...
    datePicker.prototype.updateStatus = function (msg) {
        ...
        if (
            msg &&
            this.statusFormat.search(/%S/) != -1 &&
            msg.search(/([0-9]{1,2})(st|nd|rd|th)/) != -1
        ) {
            msg = cbSplit(
                msg.replace(/([0-9]{1,2})(st|nd|rd|th)/, "$1<sup>$2</sup>"),
                /<sup>|<\/sup>/
            );
    ...
    datePicker.prototype.setDateFromInput = function () {
        var origDateSet = this.dateSet,
            ...
            but = this.staticPos
                ? false
                : document.getElementById("fd-but-" + this.id),
            e = localeImport.imported
                ? []
                      .concat(localeDefaults.fullMonths)
                      .concat(localeDefaults.monthAbbrs)
                : [],
            l = localeImport.imported
                ? []
    ...
    datePicker.prototype.showHideButtons = function (tmpDate) {
        ...
        if (
            this.outOfRange(
                new Date(tdy - 1, tdm, daysInMonth(+tdm, tdy - 1), 5, 0, 0)
            )
        ) {
        ...
        if (
            this.outOfRange(
                new Date(tdy, +tdm - 1, daysInMonth(+tdm - 1, tdy), 5, 0, 0)
            )
        ) {
            ...
            switch (part) {
                ...
                case "j": // Day of the month without leading zeros (1 - 31)
                    if (str.search(/^(3[01]|[12][0-9]|[1-9])/) != -1) {
                        ...
                        str = str.substr(
                            str.match(/^(3[01]|[12][0-9]|[1-9])/)[0].length
                        );
                        break;
                    } else {
                        return false;
                ...
                case "l": // A full textual representation of the day of the week (Monday - Sunday)
                    ...
                    if (localeImport.imported) {
                        l = l
                            .concat(localeImport.fullDays)
                            .concat(localeImport.dayAbbrs);
                    }
                ...
                case "W": // ISO-8601 week number of year, weeks starting on Monday (added in PHP 4.1.0): 1 - 53
                    if (str.search(/^([1-9]|[1234[0-9]|5[0-3])/) != -1) {
                        str = str.substr(
                            str.match(/^([1-9]|[1234[0-9]|5[0-3])/)[0].length
                        );
                    }
                    break;
                // MONTH
                ...
                case "F": // A full textual representation of a month, such as January or March
                    // Accept English & imported locales and both modifiers
                    l = localeDefaults.fullMonths.concat(
                        localeDefaults.monthAbbrs
                    );
                    if (localeImport.imported) {
                        l = l
                            .concat(localeImport.fullMonths)
    ...
    var addDatePicker = function (options) {
            ...
            if (!options.formElements[elemID].match(formatTestRegExp)) {
                if (debug) {
                    throw (
                        "Element '" +
                        elemID +
                        "' has a date format that does not contain either a day (d|j), month (m|F|n) or year (y|Y) part: " +
                        options.formElements[elemID]
                    );
                }
                return false;
            }
        ...
        if (!(partsFound.d == 1 && partsFound.m == 1 && partsFound.y == 1)) {
            if (debug) {
                throw (
                    "Could not find all of the required date parts within the date format for element: " +
                    elem.id
                );
            }
            return false;
        ...
        opts = {
            ...
            positioned:
                options.positioned &&
                document.getElementById(options.positioned)
                    ? options.positioned
                    : "",
            // Ranges stipulated in YYYYMMDD format
            rangeLow:
                options.rangeLow &&
                String(options.rangeLow).search(rangeRegExp) != -1
                    ? options.rangeLow
                    : "",
            rangeHigh:
                options.rangeHigh &&
                String(options.rangeHigh).search(rangeRegExp) != -1
                    ? options.rangeHigh
                    : "",
            // Status bar format
            ...
            bespokeTabIndex:
                options.bespokeTabindex &&
                typeof options.bespokeTabindex == "number"
            ...
            finalOpacity:
                ...
                options.finalOpacity > 20 &&
                options.finalOpacity <= 100
            ...
            describedBy:
                options.describedBy &&
                document.getElementById(options.describedBy)
                    ? options.describedBy
            ...
            bespokeClass: options.bespokeClass
                ? " " + options.bespokeClass
                : "",
        };
    ...
    var testCSSAnimationSupport = function () {
        ...
        for (t = 0; t < transitions.length; t++) {
            if (transitions[t] in elm.style) {
                transitionEnd =
                    transitions[t] == "webkitTransition" ||
                    transitions[t] == "OTransition"
                        ? transitions[t] + "End"
                        : "transitionend";
                break;
            }
